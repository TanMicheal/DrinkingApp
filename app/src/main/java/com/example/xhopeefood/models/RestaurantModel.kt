package com.example.xhopeefood.models

import android.os.Parcel
import android.os.Parcelable

data class RestaurentModel(
    val name: String?, val address: String?, val delivery_charge: String?,
...
data class Hours(val Sunday: String?, val Monday: String?, val Tuesday: String?,
    val Wednesday: String?, val Thursday: String?, val Friday: String?, val Saturday: String?) :
    Parcelable {
    constructor(parcel: Parcel) : this(
        parcel.readString(),
        parcel.readString(),
